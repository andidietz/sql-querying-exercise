...
INSERT INTO products (name, price, can_be_returned) VALUES ('lamp', 39.99, false);

-- Display only the products that can_be_returned.
SELECT * FROM products WHERE can_be_returned = true;

-- Display only the products that have a price less than 44.00.
SELECT * FROM products WHERE price < 40.00;
...
UPDATE products SET price = price - (price * 20.00 / 100);
