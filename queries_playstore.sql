...
SELECT * FROM analytics WHERE price BETWEEN .10 AND 1 ORDER BY rating DESC LIMIT 10;
...
SELECT app_name, reviews, min_installs, min_installs/reviews AS proportion FROM analyt
ics WHERE min_installs < 100000 ORDER BY proportion LIMIT 1;